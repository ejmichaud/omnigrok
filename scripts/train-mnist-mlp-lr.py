...
ex = Experiment("train-mnist-mlp-lr")
...
def run(train_points,
    ...
    optimizer = optimizer_dict[optimizer]([
        {'params': mlp[:-1].parameters(), 'lr': lr, 'weight_decay': weight_decay},
        {'params': mlp[-1].parameters(), 'lr': last_layer_lr, 'weight_decay': weight_decay}
    ])
